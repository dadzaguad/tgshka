...
@router.callback_query(F.data == "shorts")
async def shorts(callback: CallbackQuery):
    await callback.answer("Вы выбрали категорию", show_alert=True)
    await callback.message.answer("Вы выбрали категорию шорты")


@router.callback_query(F.data == "hats")
async def hats(callback: CallbackQuery):
    await callback.answer("Вы выбрали категорию", show_alert=True)
    await callback.message.answer("Вы выбрали категорию кепки")
